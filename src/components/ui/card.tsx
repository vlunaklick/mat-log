...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center rounded-b-3xl border-t border-border-soft bg-muted/50 p-(--card-spacing)",
        className
      )}
      {...props}
    />
