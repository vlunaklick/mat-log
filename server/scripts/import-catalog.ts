...
if (entries.length < 500)
  throw new Error("Unexpected catalog size; inspect the upstream format.");
  ...
  JSON.stringify(
    {
      ...
      license: "Public domain (upstream LICENSE)",
      entries,
    },
    null,
    2,
...
console.log(
  `Imported ${entries.length} named positions/transitions; unfinished placeholders excluded.`,
);
